...
class __TwigTemplate_a019c0867c27b6dcae23e4f368c309ae extends Twig_Template
{
...
\t\t\t\t\t\t\t\t<img src=\"";
            // line 24
            $this->env->loadTemplate("user_photo.html.twig")->display(array_merge($context, array("user" => $this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user"))));
            echo "\" alt=\"\"/>
\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t<span class=\"hidden-xs\">";
            ...
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user"), "lastname"), "html", null, true);
            echo "</span> <b class=\"caret\"></b>
\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t<ul class=\"dropdown-menu dropdown-menu-right\">
\t\t\t\t\t\t\t\t<li><a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_show", array("id" => $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user"), "id"))), "html", null, true);
