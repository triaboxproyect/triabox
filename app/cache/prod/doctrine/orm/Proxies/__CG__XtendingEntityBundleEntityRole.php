 ...
 */
class Role extends \Xtending\EntityBundle\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::addContacto($contacto);
    }


    public function __sleep()
    {
        return array('__isInitialized__', 'id', 'name', 'role', 'contactos');
    }
