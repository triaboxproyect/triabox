 ...
 */
class GrupoPregunta extends \Xtending\EntityBundle\Entity\GrupoPregunta implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::getPreguntasResumen();
    }

    public function getPreguntasCapitulo()
    {
        $this->__load();
        return parent::getPreguntasCapitulo();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'nombre', 'preguntas', 'formulariosDefiniciones');
    }
