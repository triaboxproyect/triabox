...
/* EventBundle:Result:result_notification.html.twig */
class __TwigTemplate_02263d376467dda24c21d712856b44e3 extends Twig_Template
{
...
\t\t";
        // line 4
        if ((twig_length_filter($this->env, (isset($context["classifications"]) ? $context["classifications"] : $this->getContext($context, "classifications"))) > 0)) {
            echo "<span class=\"count\" >";
            echo twig_escape_filter($this->env, twig_length_filter($this->env, (isset($context["classifications"]) ? $context["classifications"] : $this->getContext($context, "classifications"))), "html", null, true);
            echo "</span>";
        }
        // line 5
        echo "\t</a>
...
\t\t";
        ...
        if ((twig_length_filter($this->env, (isset($context["classifications"]) ? $context["classifications"] : $this->getContext($context, "classifications"))) > 0)) {
            ...
            echo $this->env->getExtension('translator')->getTranslator()->trans("Tiene", array(), "messages");
            echo " ";
            echo twig_escape_filter($this->env, twig_length_filter($this->env, (isset($context["classifications"]) ? $context["classifications"] : $this->getContext($context, "classifications"))), "html", null, true);
            echo " ";
            echo $this->env->getExtension('translator')->getTranslator()->trans("Clasificaciones", array(), "messages");
            echo "</li>";
        }
        // line 13
        echo "\t\t
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["classifications"]) ? $context["classifications"] : $this->getContext($context, "classifications")));
...
\t\t\t\t\t\t";
            // line 22
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["classification"]) ? $context["classification"] : $this->getContext($context, "classification")), "event"), "name"), "html", null, true);
            echo "
\t\t\t\t\t</span>
...
\t\t\t\t<span class=\"time\"><i class=\"fa fa-clock-o\"></i>";
            // line 28
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["classification"]) ? $context["classification"] : $this->getContext($context, "classification")), "event"), "startTime"), "d.m.y"), "html", null, true);
            echo "</span>
\t\t\t</a>
\t\t</li>
\t\t";
...
\t\t\t";
        // line 34
        echo $this->env->getExtension('translator')->getTranslator()->trans("Ver todas las clasificaciones", array(), "messages");
        // line 35
        echo "\t\t\t\t
\t\t\t</a>
\t\t</li>
\t</ul>
    ...
    {
        return "EventBundle:Result:result_notification.html.twig";
    }
