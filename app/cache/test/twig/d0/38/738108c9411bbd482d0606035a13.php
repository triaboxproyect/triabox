...
/* NewsUserBundle:NewsUser:notificationEvent.html.twig */
class __TwigTemplate_d038738108c9411bbd482d0606035a13 extends Twig_Template
{
...
\t<a class=\"btn dropdown-toggle\" data-toggle=\"dropdown\" id=\"notificationEvent\" >
...
\t\t\t<a href=\"";
            // line 16
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("event_show", array("id" => $this->getAttribute($this->getAttribute((isset($context["news"]) ? $context["news"] : $this->getContext($context, "news")), "event"), "id"))), "html", null, true);
            echo "\">
\t\t\t\t<i class=\"fa fa-comment\"></i>
\t\t\t\t<span class=\"content\">";
            // line 18
            if (($this->getAttribute((isset($context["news"]) ? $context["news"] : $this->getContext($context, "news")), "type") == "03")) {
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["news"]) ? $context["news"] : $this->getContext($context, "news")), "user"), "name"), "html", null, true);
            }
            echo "  ";
            ...
            echo " ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["news"]) ? $context["news"] : $this->getContext($context, "news")), "event"), "name"), "html", null, true);
            echo " </span>
";
            // line 20
            echo "\t\t\t</a>
...
";
    ...
    {
        return "NewsUserBundle:NewsUser:notificationEvent.html.twig";
    }
