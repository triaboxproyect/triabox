...
class __TwigTemplate_1db48820037105ee5a971ca9041d3164 extends Twig_Template
{
    ...
    {
        // line 1
        if ((!(null === $this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "photo")))) {
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl($this->getAttribute((isset($context["user"]) ? $context["user"] : $this->getContext($context, "user")), "photo")), "html", null, true);
        } else {
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl("bundles/cube/img/swim_bike_run.jpg"), "html", null, true);
        }
    }

    public function getTemplateName()
    {
        return "user_photo.html.twig";
    }
